...
ALTER TABLE `fgt_optionlist` ADD COLUMN IF NOT EXISTS  `optionlist_name` varchar(30)   AFTER `optionlist_id`;
...
ALTER TABLE `fgt_optionlist` MODIFY COLUMN IF EXISTS  `optionlist_name` varchar(30)    AFTER `optionlist_id`;
